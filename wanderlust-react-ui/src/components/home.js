                ...
                <header className="masthead book-page" id="page-top">
                    ...
                    Not all those who wander are lost.</h2>
                            <div className="form-inline d-flex">
                                <InputText 
                                    type="text"
                                    className="form-control-lg flex-fill p-inputtext"
                                    name="continent"
                                    ...
                                    placeholder="Where?"
                                />&nbsp;
                    <button className="btn btn-lg btn-primary" style={{height:60,width:150}} onClick={this.getPackages}>Search</button>
                            </div>
                        </div>
                    </div>
                </header>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-8 mx-auto">
                                ...
                                At <Link to="/" onClick={window.scrollTo({top: 0, left: 0, behavior: 'smooth'})} >Wanderlust</Link>, we take care of all the requirements to ensure that you get to enjoy the best of your holiday, exploring and experiencing the destination.</p>
                            </div>
                        </div>
                    </div>
                </section>
                            ...
                            <div className="col-md-4 mb-3 mb-md-0">
                                <div className="card py-4 h-100">
                                    <div className="card-body text-center">
                                        ...
                                        <hr className="my-4" />
                                        <div className="small text-black-50"><Link to="/home">pradeep.ravibaskar@gmail.com</Link></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-md-4 mb-3 mb-md-0">
                                <div className="card py-4 h-100">
                                    <div className="card-body text-center">
                                        ...
                                        <hr className="my-4" />
                                        <div className="small text-black-50">+91 8754398706</div>
                                    </div>
                                </div>
                            </div>
                        </div>
